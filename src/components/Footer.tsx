    ...
    <footer className="bg-brand-dark py-[clamp(2.5rem,8vw,4.5rem)]">
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-12 mb-8 sm:mb-12">
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-primary mb-3 sm:mb-4 text-sm uppercase tracking-widest">Quick Links</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold text-primary mb-3 sm:mb-4 text-sm uppercase tracking-widest">Contact</h4>
